...
const stitch = __webpack_require__(11);
...
class Mission {
  constructor({
    ...
    this.queryDB = function(database = this.databaseCollection, query) {
      ...
      const geoJSONTrails = __webpack_require__(77);
...
const Mission = __webpack_require__(7);
